...
Row(
children: [
Radio<String>(value: "Patient", groupValue: _selectedRole, onChanged: (v) => setState(() => _selectedRole = v!)),
const Text("Patient"),
Radio<String>(value: "Doctor", groupValue: _selectedRole, onChanged: (v) => setState(() => _selectedRole = v!)),
const Text("Doctor"),
],
),
const SizedBox(height: 20),
