...
children: [
SizedBox(width: 100, child: ElevatedButton(onPressed: () => Navigator.pop(context), style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFF0F0F0), elevation: 0, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: Colors.grey.shade300))), child: const Text("NO", style: TextStyle(color: Colors.black)))),
SizedBox(width: 100, child: ElevatedButton(onPressed: () async {
Navigator.pop(context);
await ref.read(authProvider.notifier).deleteAccount();
}, style: ElevatedButton.styleFrom(backgroundColor: Colors.white, elevation: 0, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: const BorderSide(color: Colors.red))), child: const Text("Yes", style: TextStyle(color: Colors.red)))),
],
),
],
),
...
Text("Hi, $displayName", style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
],
),
Row(
children: [
...
children: [
_actionTile(context, "Book\nAppointment", Icons.calendar_today, Colors.blue, '/book-appointment'),
_actionTile(context, "My\nAppointments", Icons.access_time, Colors.purple, '/my-appointments'),
_actionTile(context, "Check In", Icons.people_outline, Colors.green, '/check-in'),
_actionTile(context, "Visit\nHistory", Icons.description_outlined, Colors.blueAccent, '/visit-summary'),
],
),
],
),
...
Widget _actionTile(BuildContext context, String title, IconData icon, Color color, String route) {
return InkWell(
